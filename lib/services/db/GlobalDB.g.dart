...
NotificationDB _notificationDBDeserialize(
  ...
  object.id = id;
  object.payload = reader.readStringOrNull(offsets[1]);
...
extension GetPlayStatisticsDBCollection on Isar {
  IsarCollection<PlayStatisticsDB> get playStatisticsDBs => this.collection();
}

const PlayStatisticsDBSchema = CollectionSchema(
  name: r'PlayStatisticsDB',
  id: 5867633468663892732,
  properties: {
    r'album': PropertySchema(
      id: 0,
      name: r'album',
    ...
    r'playTimestamps': PropertySchema(
      id: 5,
      name: r'playTimestamps',
  ...
  estimateSize: _playStatisticsDBEstimateSize,
  serialize: _playStatisticsDBSerialize,
  deserialize: _playStatisticsDBDeserialize,
  deserializeProp: _playStatisticsDBDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  links: {},
  embeddedSchemas: {},
  getId: _playStatisticsDBGetId,
  getLinks: _playStatisticsDBGetLinks,
  attach: _playStatisticsDBAttach,
  version: '3.3.0',
);

int _playStatisticsDBEstimateSize(
  PlayStatisticsDB object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  ...
  bytesCount += 3 + object.artist.length * 3;
  bytesCount += 3 + object.mediaId.length * 3;
  bytesCount += 3 + object.playTimestamps.length * 8;
  bytesCount += 3 + object.title.length * 3;
  return bytesCount;
}

void _playStatisticsDBSerialize(
  PlayStatisticsDB object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeDateTimeList(offsets[5], object.playTimestamps);
  writer.writeString(offsets[6], object.title);
}

PlayStatisticsDB _playStatisticsDBDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = PlayStatisticsDB(
    album: reader.readString(offsets[0]),
    artist: reader.readString(offsets[1]),
    id: id,
    ...
    playTimestamps: reader.readDateTimeList(offsets[5]) ?? [],
    title: reader.readString(offsets[6]),
  );
  return object;
}

P _playStatisticsDBDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _playStatisticsDBGetId(PlayStatisticsDB object) {
  return object.id ?? Isar.autoIncrement;
}

List<IsarLinkBase<dynamic>> _playStatisticsDBGetLinks(PlayStatisticsDB object) {
  return [];
}

void _playStatisticsDBAttach(
    IsarCollection<dynamic> col, Id id, PlayStatisticsDB object) {
  object.id = id;
}

extension PlayStatisticsDBByIndex on IsarCollection<PlayStatisticsDB> {
  Future<PlayStatisticsDB?> getByMediaId(String mediaId) {
    return getByIndex(r'mediaId', [mediaId]);
  }

  PlayStatisticsDB? getByMediaIdSync(String mediaId) {
  ...
  Future<List<PlayStatisticsDB?>> getAllByMediaId(List<String> mediaIdValues) {
    final values = mediaIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'mediaId', values);
  }

  List<PlayStatisticsDB?> getAllByMediaIdSync(List<String> mediaIdValues) {
    final values = mediaIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByMediaId(PlayStatisticsDB object) {
    return putByIndex(r'mediaId', object);
  }

  Id putByMediaIdSync(PlayStatisticsDB object, {bool saveLinks = true}) {
    return putByIndexSync(r'mediaId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByMediaId(List<PlayStatisticsDB> objects) {
    return putAllByIndex(r'mediaId', objects);
  }

  List<Id> putAllByMediaIdSync(List<PlayStatisticsDB> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'mediaId', objects, saveLinks: saveLinks);
  }
}

extension PlayStatisticsDBQueryWhereSort
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QWhere> {
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }
...
extension PlayStatisticsDBQueryWhere
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QWhereClause> {
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterWhereClause> idEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(
        lower: id,
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterWhereClause>
      idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlayStatisticsDBQueryFilter
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QFilterCondition> {
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterFilterCondition>
      albumEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterFilterCondition>
      playTimestampsElementEqualTo(DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'playTimestamps',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterFilterCondition>
      playTimestampsElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterFilterCondition>
      playTimestampsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'playTimestamps',
        length,
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterFilterCondition>
      playTimestampsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension PlayStatisticsDBQueryObject
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QFilterCondition> {}

extension PlayStatisticsDBQueryLinks
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QFilterCondition> {}

extension PlayStatisticsDBQuerySortBy
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QSortBy> {
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterSortBy> sortByAlbum() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'album', Sort.asc);
    });
  }

  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterSortBy>
      sortByAlbumDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'album', Sort.desc);
    });
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }
...
extension PlayStatisticsDBQuerySortThenBy
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QSortThenBy> {
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterSortBy> thenByAlbum() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'album', Sort.asc);
    });
  }
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }
...
extension PlayStatisticsDBQueryWhereDistinct
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QDistinct> {
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QDistinct> distinctByAlbum(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'album', caseSensitive: caseSensitive);
    });
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QDistinct> distinctByArtist(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'artist', caseSensitive: caseSensitive);
    });
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QDistinct>
      distinctByLastPlayed() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastPlayed');
    });
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QDistinct> distinctByMediaId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'mediaId', caseSensitive: caseSensitive);
    });
  ...
  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QDistinct>
      distinctByPlayTimestamps() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'playTimestamps');
    });
  }

  QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'title', caseSensitive: caseSensitive);
    });
...
extension PlayStatisticsDBQueryProperty
    on QueryBuilder<PlayStatisticsDB, PlayStatisticsDB, QQueryProperty> {
  QueryBuilder<PlayStatisticsDB, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<PlayStatisticsDB, String, QQueryOperations> albumProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'album');
    });
  }

  QueryBuilder<PlayStatisticsDB, String, QQueryOperations> artistProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'artist');
    });
  }

  QueryBuilder<PlayStatisticsDB, DateTime, QQueryOperations>
      lastPlayedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastPlayed');
    });
  ...
  QueryBuilder<PlayStatisticsDB, String, QQueryOperations> mediaIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'mediaId');
    });
  }

  QueryBuilder<PlayStatisticsDB, int, QQueryOperations> playCountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'playCount');
    });
  }

  QueryBuilder<PlayStatisticsDB, List<DateTime>, QQueryOperations>
      playTimestampsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'playTimestamps');
    });
  }

  QueryBuilder<PlayStatisticsDB, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'title');
    });
  }
...
extension GetSavedQueueDBCollection on Isar {
  IsarCollection<SavedQueueDB> get savedQueueDBs => this.collection();
}

const SavedQueueDBSchema = CollectionSchema(
  name: r'SavedQueueDB',
  id: 4695795303007951942,
  properties: {
    ...
    r'mediaItemsJson': PropertySchema(
      id: 1,
      name: r'mediaItemsJson',
  ...
  estimateSize: _savedQueueDBEstimateSize,
  serialize: _savedQueueDBSerialize,
  deserialize: _savedQueueDBDeserialize,
  deserializeProp: _savedQueueDBDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  links: {},
  embeddedSchemas: {},
  getId: _savedQueueDBGetId,
  getLinks: _savedQueueDBGetLinks,
  attach: _savedQueueDBAttach,
  version: '3.3.0',
);

int _savedQueueDBEstimateSize(
  SavedQueueDB object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  bytesCount += 3 + object.mediaItemsJson.length * 3;
  {
    for (var i = 0; i < object.mediaItemsJson.length; i++) {
      final value = object.mediaItemsJson[i];
...
void _savedQueueDBSerialize(
  ...
  writer.writeStringList(offsets[1], object.mediaItemsJson);
  writer.writeLong(offsets[2], object.positionMs);
  writer.writeString(offsets[3], object.queueName);
  writer.writeDateTime(offsets[4], object.savedAt);
}

SavedQueueDB _savedQueueDBDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = SavedQueueDB(
    currentIndex: reader.readLong(offsets[0]),
    id: id,
    mediaItemsJson: reader.readStringList(offsets[1]) ?? [],
    positionMs: reader.readLong(offsets[2]),
    queueName: reader.readString(offsets[3]),
    savedAt: reader.readDateTime(offsets[4]),
  );
  return object;
}

P _savedQueueDBDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _savedQueueDBGetId(SavedQueueDB object) {
  return object.id ?? Isar.autoIncrement;
}

List<IsarLinkBase<dynamic>> _savedQueueDBGetLinks(SavedQueueDB object) {
  return [];
}

void _savedQueueDBAttach(
    IsarCollection<dynamic> col, Id id, SavedQueueDB object) {
  object.id = id;
}

extension SavedQueueDBQueryWhereSort
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QWhere> {
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }
...
extension SavedQueueDBQueryWhere
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QWhereClause> {
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(
        lower: id,
        upper: id,
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhereClause> idNotEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhereClause> idGreaterThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: id, includeUpper: include),
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhereClause> queueNameEqualTo(
      String queueName) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterWhereClause>
...
extension SavedQueueDBQueryFilter
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QFilterCondition> {
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'id',
      ));
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition> idEqualTo(
      Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition> idGreaterThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition> idLessThan(
    Id? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition> idBetween(
    Id? lower,
    Id? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'mediaItemsJson',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'mediaItemsJson',
        value: value,
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonElementMatches(String pattern,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'mediaItemsJson',
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'mediaItemsJson',
        value: '',
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'mediaItemsJson',
        length,
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterFilterCondition>
      mediaItemsJsonLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension SavedQueueDBQueryObject
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QFilterCondition> {}

extension SavedQueueDBQueryLinks
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QFilterCondition> {}

extension SavedQueueDBQuerySortBy
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QSortBy> {
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> sortByCurrentIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentIndex', Sort.asc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy>
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> sortByPositionMs() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> sortByQueueName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'queueName', Sort.asc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> sortByQueueNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'queueName', Sort.desc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> sortBySavedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAt', Sort.asc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> sortBySavedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SavedQueueDBQuerySortThenBy
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QSortThenBy> {
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenByCurrentIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentIndex', Sort.asc);
    });
  }
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.desc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenByPositionMs() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'positionMs', Sort.asc);
    });
  }
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenByQueueName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'queueName', Sort.asc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenByQueueNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'queueName', Sort.desc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenBySavedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAt', Sort.asc);
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QAfterSortBy> thenBySavedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'savedAt', Sort.desc);
    });
  }
...
extension SavedQueueDBQueryWhereDistinct
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QDistinct> {
  QueryBuilder<SavedQueueDB, SavedQueueDB, QDistinct> distinctByCurrentIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'currentIndex');
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QDistinct>
      distinctByMediaItemsJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'mediaItemsJson');
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QDistinct> distinctByPositionMs() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'positionMs');
    });
  }

  QueryBuilder<SavedQueueDB, SavedQueueDB, QDistinct> distinctByQueueName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SavedQueueDB, SavedQueueDB, QDistinct> distinctBySavedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension SavedQueueDBQueryProperty
    on QueryBuilder<SavedQueueDB, SavedQueueDB, QQueryProperty> {
  QueryBuilder<SavedQueueDB, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<SavedQueueDB, int, QQueryOperations> currentIndexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currentIndex');
    });
  }

  QueryBuilder<SavedQueueDB, List<String>, QQueryOperations>
      mediaItemsJsonProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'mediaItemsJson');
    });
  }

  QueryBuilder<SavedQueueDB, int, QQueryOperations> positionMsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'positionMs');
    });
  }

  QueryBuilder<SavedQueueDB, String, QQueryOperations> queueNameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'queueName');
    });
  }

  QueryBuilder<SavedQueueDB, DateTime, QQueryOperations> savedAtProperty() {
    return QueryBuilder.apply(this, (query) {
