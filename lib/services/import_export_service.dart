...
class ImportExportService {
      ...
      try {
        ...
        if (playlistItems != null) {
          ...
          final Map<String, dynamic> playlistMap = {
            '_meta': {
              'generated_by':
                  'Musicly - Open Source Music Streaming Application',
              'version':
                  'v${packageInfo.version}+${int.parse(packageInfo.buildNumber) % 1000}',
              'exportedAt': DateTime.now().toIso8601String(),
              'note':
                  'This file is automatically generated by Musicly and is intended solely for importing playlists within the application. Manual modification of this file is strongly discouraged, as it may result in errors, data inconsistency, or failed imports. For support or more information, please visit: https://github.com/HemantKArya/BloomeeTunes.',
            },
          ...
          final path = await writeToJSON(
              '${mediaPlaylistDB.playlistName}_MusiclyPlaylist.json',
              playlistMap,
              path: filePath);
  ...
  static Future<String?> exportMediaItem(MediaItemDB mediaItemDB) async {
    try {
      ...
      final packageInfo = await PackageInfo.fromPlatform();
      mediaItemMap['_meta'] = {
        'generated_by': 'Musicly - Open Source Music Streaming Application',
        'version':
            'v${packageInfo.version}+${int.parse(packageInfo.buildNumber) % 1000}',
        'exportedAt': DateTime.now().toIso8601String(),
        'note':
      ...
      final path = await writeToJSON(
          '${mediaItemDB.title}_MusiclySong.json', mediaItemMap);
